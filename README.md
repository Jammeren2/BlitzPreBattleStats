...
# Внимание: Поддержка прекращена ❌  
Данное приложение больше не поддерживается. Разработка и обновления прекращены, а новые исправления или функции добавляться не будут.  
Спасибо всем, кто пользовался приложением!  
